...
#import "AttributeTwoViewController.h"


@interface AttributeOneViewController ()

@end

@implementation AttributeOneViewController
...
-(void)clickJump{
    AttributeTwoViewController *attTwo = [AttributeTwoViewController new];
    attTwo.inputValue = @"你接收到值了么？";
