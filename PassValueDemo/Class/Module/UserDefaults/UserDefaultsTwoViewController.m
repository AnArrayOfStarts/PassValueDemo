...
@interface UserDefaultsTwoViewController ()

@end

@implementation UserDefaultsTwoViewController
...
-(void)clickBack{
    [[NSUserDefaults standardUserDefaults] setObject:self.textField.text forKey:@"NSUserDefaultsTwo"];
...
-(UITextField *)textField{
    if (!_textField) {
        ...
        // NSUserDefaults正向传值
        _textField.text = [[NSUserDefaults standardUserDefaults] objectForKey:@"NSUserDefaultsOne"];
