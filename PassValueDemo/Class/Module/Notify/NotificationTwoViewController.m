...
@interface NotificationTwoViewController ()

@end

@implementation NotificationTwoViewController
...
-(void)clickBack{
    // 广播通知
    [[NSNotificationCenter defaultCenter] postNotificationName:@"notifyCenter" object:nil userInfo:@{@"value":self.textField.text}];
